...
public class RetailShopClient {
    ...
    public <T> T RetailerProduct_Select_ById(Class<T> responseType, String Id) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("RetailerProduct/GetById/{0}", new Object[]{Id}));
    ...
    public <T> T Product_Insert(Class<T> responseType, String Name, String Price, String Description, String IsActive, String CategoryId) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("Product/Post/{0}/{1}/{2}/{3}/{4}", new Object[]{Name, Price, Description, IsActive, CategoryId})).request().post(null, responseType);
    }
    ...
    public <T> T RetailerProduct_SelectAll_ByRetailerId(Class<T> responseType, String RetailerId) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("RetailerProduct/GetByRetailer/{0}", new Object[]{RetailerId}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
    ...
    public <T> T Product_Update(Class<T> responseType, String Id, String Name, String Price, String Description, String IsActive, String CategoryId) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("Product/Put/{0}/{1}/{2}/{3}/{4}/{5}", new Object[]{Id, Name, Price, Description, IsActive, CategoryId})).request().post(null, responseType);
    }
    ...
    public <T> T Wishlist_Insert(Class<T> responseType, String UserId, String ProductId) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("Wishlist/Post/{0}/{1}", new Object[]{UserId, ProductId})).request().post(null, responseType);
    }
    ...
    public <T> T Wishlist_Delete(Class<T> responseType, String Id) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("Wishlist/Delete/{0}", new Object[]{Id})).request().post(null, responseType);
    }

    public <T> T RetailerProduct_Update_IsActive(Class<T> responseType, String Id, String IsActive) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("RetailerProduct/PutStatus/{0}/{1}", new Object[]{Id, IsActive})).request().post(null, responseType);
    }

    public <T> T RetailerProduct_Update(Class<T> responseType, String Id, String Price, String Quantity, String IsActive, String ProductId) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("RetailerProduct/Put/{0}/{1}/{2}/{3}/{4}", new Object[]{Id, Price, Quantity, IsActive, ProductId})).request().post(null, responseType);
    }
    ...
    public <T> T Wishlist_SelectAll_ByUserId(Class<T> responseType, String UserId) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("Wishlist/GetByUser/{0}", new Object[]{UserId}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
    ...
    public <T> T RetailerProduct_Delete(Class<T> responseType, String Id) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("RetailerProduct/Delete/{0}", new Object[]{Id})).request().post(null, responseType);
    }
    ...
    public <T> T userLogin(Class<T> responseType, String Username, String Password) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("User/Login/{0}/{1}", new Object[]{Username, Password})).request().post(null, responseType);
    }
    ...
    public <T> T RetailerProduct_Insert(Class<T> responseType, String Price, String Quantity, String IsActive, String RetailerId, String ProductId) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("RetailerProduct/Post/{0}/{1}/{2}/{3}/{4}", new Object[]{Price, Quantity, IsActive, RetailerId, ProductId})).request().post(null, responseType);
    }
